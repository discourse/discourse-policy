...
class MigrateCustomFieldToLogs < ActiveRecord::Migration[5.2]
  def up
    execute(<<~SQL)
    INSERT INTO user_policy_logs(post_policy_id, user_id, version, accepted_at, created_at, updated_at)
